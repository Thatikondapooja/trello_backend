...
export class CardsController {
  ...
  moveCard(
    ...
    return this.cardsService.moveCard(cardId, dto.toListId, {
      ...req.user,
      id: req.user.userId,
    });
  }
  ...
  // PATCH /cards/:id
  @Patch(':id')
  updateCard(@Param('id') id: number, @Body() dto: UpdateCardDto, @Req() req) {
  ...
  @Post(':cardId/members')
  addMember(@Param('cardId') cardId: string, @Body('userId') userId: number) {
    return this.cardsService.addMemberToCard(Number(cardId), userId);
  }
