...
describe('CardsController', () => {
  ...
  it('should move card', async () => {
    ...
    const result = await controller.moveCard(1, dto as any, mockReq as any);

    expect(service.moveCard).toHaveBeenCalledWith(1, dto.toListId, {
      ...mockReq.user,
      id: mockReq.user.userId,
    });
  ...
  it('should update card', async () => {
    ...
    const result = await controller.updateCard(1, dto as any, mockReq as any);

    expect(service.updateCard).toHaveBeenCalledWith(1, dto, {
      ...mockReq.user,
      id: mockReq.user.userId,
    });
