...
describe('AuthController', () => {
  ...
  it("should call authService.register with correct parameters", async () => {
    const registerData = {  FullName:"jhow" ,email:"jhow@gmail.com" ,password:"jhow123"};
    ...
    // expect(mockAuthService.register).toHaveBeenCalledWith(registerData.FullName, registerData.email, registerData.password);
        expect(mockAuthService.register).toHaveBeenCalledWith("jhow", "jhow@gmail.com", "jhow123");
  ...
  it("should call authService.login with correct parameters",async()=>{
   ...
   it("should call authService.refresh with correct parameters",async()=>{
    ...
    expect(mockAuthService.refresh).toHaveBeenCalledWith(resetData.refreshToken);
